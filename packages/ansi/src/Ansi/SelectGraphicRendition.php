...
/**
 * Copied from https://github.com/bramus/ansi-php/blob/master/src/ControlSequences/EscapeSequences/SGR.php
 */
final class SelectGraphicRendition
{
     ...
     * @type string
     */
    public const STYLE_INTENSITY_BRIGHT = '1';
     ...
     * @type string
     */
    public const STYLE_INTENSITY_FAINT = '2';
     ...
     * @type string
     */
    public const STYLE_BLINK_RAPID = '6';

    /**
     * Inverse or reverse colors (viz. swap foreground and background)
     * @type string
     */
    public const STYLE_NEGATIVE = '7';
     ...
     * @type string
     */
    public const STYLE_INTENSITY_NORMAL = '22';

    /**
     * Bold: Off ~or~ normal intensity
     * @type string
     */
    public const STYLE_BOLD_OFF = '22';
     ...
     * @type string
     */
    public const STYLE_ITALIC_OFF = '23';

    /**
     * Underline: Off
     * @type string
     */
    public const STYLE_UNDERLINE_OFF = '24';

    /**
     * Blink: Off (Steady)
     * @type string
     */
    public const STYLE_STEADY = '5';
    public const STYLE_BLINK_OFF = '5';

    /**
     * Positive Image (viz. don't swap foreground and background)
     * @type string
     */
    public const STYLE_POSITIVE = '27';

    /**
     * Revealed Charcters (inverse of CONCEAL)
     * @type string
     */
    public const STYLE_REVEAL = '28';
     ...
     * @type string
     */
    public const STYLE_STRIKETHROUGH_OFF = '29';
     ...
     * @type string
     */
    public const COLOR_FG_PURPLE = '35';
     ...
     * @type string
     */
    public const COLOR_FG_WHITE = '37';

    /**
     * Default Foreground Color
     * @type string
     */
    public const COLOR_FG_RESET = '39';
     ...
     * @type string
     */
    public const COLOR_BG_PURPLE = '45';
     ...
     * @type string
     */
    public const COLOR_BG_WHITE = '47';

    /**
     * Default Background Color
     * @type string
     */
    public const COLOR_BG_RESET = '49';
     ...
     * @type string
     */
    public const STYLE_ENCIRCLED = '52';
     ...
     * @type string
     */
    public const STYLE_OVERLINED = '53';
     ...
     * @type string
     */
    public const STYLE_FRAMED_ENCIRCLED_OFF = '54';
     ...
     * @type string
     */
    public const STYLE_OVERLINED_OFF = '55';
     ...
     * @type string
     */
    public const COLOR_FG_BLACK_BRIGHT = '90';
     ...
     * @type string
     */
    public const COLOR_FG_RED_BRIGHT = '91';
     ...
     * @type string
     */
    public const COLOR_FG_GREEN_BRIGHT = '92';
     ...
     * @type string
     */
    public const COLOR_FG_YELLOW_BRIGHT = '93';
     ...
     * @type string
     */
    public const COLOR_FG_BLUE_BRIGHT = '94';
     ...
     * @type string
     */
    public const COLOR_FG_PURPLE_BRIGHT = '95';
     ...
     * @type string
     */
    public const COLOR_FG_CYAN_BRIGHT = '96';
     ...
     * @type string
     */
    public const COLOR_FG_WHITE_BRIGHT = '97';
     ...
     * @type string
     */
    public const COLOR_BG_BLACK_BRIGHT = '100';
     ...
     * @type string
     */
    public const COLOR_BG_RED_BRIGHT = '101';
     ...
     * @type string
     */
    public const COLOR_BG_GREEN_BRIGHT = '102';
     ...
     * @type string
     */
    public const COLOR_BG_YELLOW_BRIGHT = '103';
     ...
     * @type string
     */
    public const COLOR_BG_BLUE_BRIGHT = '104';
     ...
     * @type string
     */
    public const COLOR_BG_PURPLE_BRIGHT = '105';
     ...
     * @type string
     */
    public const COLOR_BG_CYAN_BRIGHT = '106';
     ...
     * @type string
     */
    public const COLOR_BG_WHITE_BRIGHT = '107';
}
